...
{  
    ...
    {   
        ...
        titleLabel = new JLabel("CUSTOMER EDITING AND DISPLAY");  //set label value for textField1  
        ...
        deleteCust.setBounds(200,260,200,40);
       ...
       //create panel to put form elements  
        ...
        add(titleLabel);
        add(displayCust);    //set username label to panel  
        add(upCust);   //set text field to panel   
        add(deleteCust);           //set button to panel  
        add(returnMain);
